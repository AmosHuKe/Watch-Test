<template>
	<view>
		...
		<view class="content">
			...
			<view class="xieyi">
				<image @tap="xieyitong" :class="xieyi?'cuIcon-radiobox':'cuIcon-round'"></image>
...
<style>
	...
	.header {
		width:161upx;
		height:161upx;
		box-shadow:0upx 12upx 13upx 0upx rgba(0,0,0,0.1);
		border-radius:50%;
		margin-top: 128upx;
		margin-left: auto;
		margin-right: auto;
