<template>
	<view>
		...
		<view class="content">
			...
			<view class="xieyi">
				<text @tap="xieyitong" :class="xieyi?'cuIcon-radiobox':'cuIcon-round'"><text>同意</text></text>
