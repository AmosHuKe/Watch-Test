    ...
    export default {
        ...
        methods: {
            getData(){
                ...
                const sportData=_this.$store.getters.getSportData; //运动数据
                const healthData=_this.$store.getters.getHealthData; //健康数据
                ...
                if(sportData!=""){
                    ...
                    .then(res => {
                        ...
                        _this.$store.dispatch('setSportData',res.data)
                    }).catch(err => {
                ...
                if(healthData!=""){
                    ...
                    .then(res => {
                        ...
                        _this.$store.dispatch('setHealthData',res.data)
                    }).catch(err => {
                        console.log(err)
                    })
                }
            ...
            ydToUrl(e){
                ...
                if(datas.indexOf("title_total_0")!=-1){
                    uni.navigateTo({
                        url: './motion/children/motion_sportData?id=1&datas='+datas,
