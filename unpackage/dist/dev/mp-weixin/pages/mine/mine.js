...
var _default = { data: function data() {return { login: false, //是否登录
    ...
    this.uerInfo = this.$store.getters.getUserData;if (this.uerInfo != "") {this.login = true;}}, methods: { goLogin: function goLogin() {//登录
      if (!this.login) {console.log("点击前往登录");uni.navigateTo({ url: './mine/children/login', animationType: 'pop-in', animationDuration: 200 });}}, loginOut: function loginOut() {//退出登录
      var _this = this;if (_this.loginOutShow) {_this.$store.dispatch("setUserData", ""); //清空登录状态
        ...
        console.log("退出登录");_this.loginOutShow = false;} else {_this.loginOutShow = true;}}, loginOutHide: function loginOutHide() {//退出登录取消
